  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Conformément au Règlement Général sur la Protection des Données (RGPD), vous disposez d'un droit d'accès, de rectification, d'opposition, d'effacement et de limitation du traitement de vos données personnelles. Pour exercer vos droits, veuillez nous contacter à l'adresse suivante : <strong>contact@pauldecalf.fr</strong>.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mb-4">
          Pour toute question ou demande concernant notre politique de cookies, vous pouvez nous contacter à l'adresse suivante : <strong>contact@pauldecalf.fr</strong>.
        </p>
      </section>
    </div>
  );
