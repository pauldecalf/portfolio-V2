  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <section className="mb-8">
        ...
        <div className="mb-4">
          <p><strong>Email :</strong> contact@pauldecalf.fr</p>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Les informations collectées via le formulaire de contact sont utilisées uniquement dans le cadre de votre demande. Conformément au RGPD, vous pouvez exercer vos droits (accès, rectification, suppression) en envoyant un email à <strong>contact@pauldecalf.fr</strong>.
        </p>
        <p className="mb-4">
